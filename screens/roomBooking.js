...
import { Alert,StyleSheet, Text, View,Image,FlatList,StatusBar,Modal,TouchableWithoutFeedback,Keyboard,ImageBackground,TouchableOpacity} from 'react-native';
             ...
             renderItem={({item})=>(
                ...
                {item?.ac &&
                  <View style={globalStyles.itemText}>
                   ...
                   <MaterialCommunityIcons name="air-conditioner" size={24} color="black" style={styles.edit}/>
                  </View>
                }
                </View>
